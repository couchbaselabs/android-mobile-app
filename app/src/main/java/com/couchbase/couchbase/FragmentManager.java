...
public class FragmentManager extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent notificationMonitor = new Intent(FragmentManager.this, NotificationMonitor.class);
        startService(notificationMonitor);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if(id == R.id.nav_dashboard){
            fragmentManager.beginTransaction()
                    .addToBackStack(null)
                    .replace(R.id.content_frame, new Dashboard()).commit();
        }
            ...
            fragmentManager.beginTransaction()
                    .addToBackStack(null)
                    .replace(R.id.content_frame, new LogList()).commit();
        }

        else if (id == R.id.nav_settings) {
            fragmentManager.beginTransaction()
                    .addToBackStack(null)
                    .replace(R.id.content_frame, new Settings()).commit();
        }
